                            ...
                            <div className="rounded-top text-white d-flex flex-row" style={{ background-color: #000, height: 200px }}>
                                <div className="ms-4 mt-5 d-flex flex-column" style="width: 150px;">
                                    ...
                                    <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-profiles/avatar-1.webp"
                                        ...
                                        alt="User custom image" className="img-fluid img-thumbnail mt-4 mb-2"
                                        style="width: 150px; z-index: 1"></img>
                                ...
                                <div className="row g-2">
                                    <div className="col mb-2">
                                        ...
                                        <img src="https://mdbcdn.b-cdn.net/img/Photos/Lightbox/Original/img%20(112).webp"
                                            ...
                                            alt="User custom image 1" className="w-100 rounded-3"></img>
                                    </div>
                                    <div className="col mb-2">
                                        ...
                                        <img src="https://mdbcdn.b-cdn.net/img/Photos/Lightbox/Original/img%20(107).webp"
                                            ...
                                            alt="User custom image 2" className="w-100 rounded-3"></img>
                                    </div>
                                </div>
                                <div className="row g-2">
                                    <div className="col">
                                        ...
                                        <img src="https://mdbcdn.b-cdn.net/img/Photos/Lightbox/Original/img%20(108).webp"
                                            ...
                                            alt="User custom image 3" className="w-100 rounded-3"></img>
                                    </div>
                                    <div className="col">
